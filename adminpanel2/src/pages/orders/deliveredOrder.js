...
import { deliveredOrderDataApi, orderDetailsApi } from "../../api/common_api";
...
const DeliveredOrder = () => {
  ...
  const deliveredOrderFunc = async (order_id) => {
    const response = await deliveredOrderDataApi(order_id);
    setdeliveredorder(response.result);
    console.log(setdeliveredorder, "dispatchedOrderData");
  };
